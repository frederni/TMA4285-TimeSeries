...
last_date <- '2021-09-30' # set Sys.Date() for current date ("2020-06-01" in paper)
...
trueobs <- apple.val$df.tickers$price.adjusted[1:21]

model0.forecast  <- forecast(model0,h = 20,lambda = 0,bootstrap = T)
model1.forecast <- ugarchboot(model1, n.ahead = 20,method="Partial",n.bootpred = 500)
model2.forecast <- ugarchboot(model2, n.ahead = 20,method="Partial",n.bootpred = 500)
model3.forecast <- ugarchboot(model3, n.ahead = 20,method="Partial",n.bootpred = 500)
model4.forecast <- ugarchboot(model4, n.ahead = 20,method="Partial",n.bootpred = 500)
...
## Model 0 ##
plot(1:n,apple.ts$df.tickers$price.adjusted[1:n],type="l",xlim=c(n-100,n+20),ylim=c(100,200))
lines(seq(n+1,n+20),model0.forecast$mean,col="red")

## Model 1 ##
plot(1:n,apple.ts$df.tickers$price.adjusted[1:n],type="l",xlim=c(n-100,n+20),ylim=c(100,200))
for(i in 1:nrow(model1.forecast)){
  lines(seq(n+1,n+20),model1.forecast[i,],col="lightgrey")
}
lines(seq(n+1,n+20),apply(model1.forecast, 2, mean),col="red")
lines(seq(n+1,n+20),apply(model1.forecast, 2, quantile,probs=0.025),col="blue")
lines(seq(n+1,n+20),apply(model1.forecast, 2, quantile,probs=0.975),col="blue")
lines(seq(n,n+20),trueobs,col="darkgreen")

## Model 2 ##
plot(1:n,apple.ts$df.tickers$price.adjusted[1:n],type="l",xlim=c(n-100,n+20),ylim=c(100,200))
for(i in 1:nrow(model2.forecast)){
  lines(seq(n+1,n+20),model2.forecast[i,],col="lightgrey")
}
lines(seq(n+1,n+20),apply(model2.forecast, 2, mean),col="red")
lines(seq(n+1,n+20),apply(model2.forecast, 2, quantile,probs=0.025),col="blue")
lines(seq(n+1,n+20),apply(model2.forecast, 2, quantile,probs=0.975),col="blue")
lines(seq(n,n+20),trueobs,col="darkgreen")

## Model 3 ##
plot(1:n,apple.ts$df.tickers$price.adjusted[1:n],type="l",xlim=c(n-100,n+20),ylim=c(100,200))
for(i in 1:nrow(model3.forecast)){
  lines(seq(n+1,n+20),model3.forecast[i,],col="lightgrey")
}
lines(seq(n+1,n+20),apply(model3.forecast, 2, mean),col="red")
lines(seq(n+1,n+20),apply(model3.forecast, 2, quantile,probs=0.025),col="blue")
lines(seq(n+1,n+20),apply(model3.forecast, 2, quantile,probs=0.975),col="blue")
lines(seq(n,n+20),trueobs,col="darkgreen")

## Model 4 ##
plot(1:n,apple.ts$df.tickers$price.adjusted[1:n],type="l",xlim=c(n-100,n+20),ylim=c(100,200))
for(i in 1:nrow(model4.forecast)){
  lines(seq(n+1,n+20),model4.forecast[i,],col="lightgrey")
}
lines(seq(n+1,n+20),apply(model4.forecast, 2, mean),col="red")
lines(seq(n+1,n+20),apply(model4.forecast, 2, quantile,probs=0.025),col="blue")
lines(seq(n+1,n+20),apply(model4.forecast, 2, quantile,probs=0.975),col="blue")
lines(seq(n,n+20),trueobs,col="darkgreen")
